...
train_df,test_df,test_df_with_id,features=deal_data.getData(submit=SUBMIT)
train=train_df
test=test_df
...
if(SUBMIT):
    test_sub['happiness']=SUBMIT_PRED
    test_sub['happiness']=test_sub['happiness'].apply(lambda x:x+1)
    test_sub.to_csv('./my_happiness_v2.csv')
    print('已经存档')
else:
    print(results_dic)
